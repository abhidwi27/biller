...
<div id="reportButtons">
	...
	<ul class="nav navbar-nav navbar-right">
		...
		<li><a class="biller-icon-separator"><span class="report-button-icon"> | </span></a></li>  
		...
		<li data-toggle="tooltip" data-original-title="Unlock Data"><a id="reportUnlock"><span ><i class="fa fa-unlock report-button-icon" ></i></span></a></li>
