...
<body>
	...
	<jsp:include page="/WEB-INF/jsp/oldjsp/header_old.jsp"></jsp:include>
	...
	<div id="tabView" class="tabs">
		...
		<div class="tab-content">
				...
				<jsp:include page="/WEB-INF/jsp/oldjsp/status_old.jsp"></jsp:include>       
 		</div>
	</div>
...
<br>
	...
	<div id="tableView"  style="display: none;">
		<jsp:include page="/WEB-INF/jsp/oldjsp/tableButton_old.jsp"></jsp:include> 
	...
	<jsp:include page="footer_old.jsp"></jsp:include> 
