...
--
-- Table structure for table `blr_wiasm_data`
--

DROP TABLE IF EXISTS `blr_wiasm_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `blr_wiasm_data` (
  `account_id` varchar(10) NOT NULL,
  `work_item` varchar(10) NOT NULL,
  `work_item_desc` varchar(100) DEFAULT NULL,
...
--
-- Dumping data for table `blr_wiasm_data`
--

LOCK TABLES `blr_wiasm_data` WRITE;
/*!40000 ALTER TABLE `blr_wiasm_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `blr_wiasm_data` ENABLE KEYS */;
UNLOCK TABLES;
